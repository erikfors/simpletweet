...
- [Room](https://guides.codepath.org/android/Twitter-Persistence-With-Room) - Twitter Persistence With Room
- [Parceler](https://guides.codepath.com/android/Using-Parceler) - Bundling model data with Parceler
